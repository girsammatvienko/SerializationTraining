    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while(true) {
            System.out.print(" 1 - Add an edition \n 2 - Delete an edition \n 3 - Print all editions \n " +
                    ...
                    "6 - Save data in bytes to externalized.bin\n 7 - Load data from externalized.bin\n 8 - Exit\n");
            ...
            switch(choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    library.writeExternal(new ObjectOutputStream(new FileOutputStream("externalized.bin")));
                    break;
                case 7:
                   library.readExternal(new ObjectInputStream(new FileInputStream("externalized.bin")));
                   break;
                case 8:
                    System.exit(0);
                    return;
